...
fun String.convertToPdf(output: OutputStream, executable: String = "", configuration: Config.() -> Unit = {}) {
    HtmlToPdf(executable = executable, configuration = configuration).convert(input = this, output = output)
}

fun String.convertToPdf(output: File, executable: String = "", configuration: Config.() -> Unit = {}) {
    HtmlToPdf(executable = executable, configuration = configuration).convert(input = this, output = output)
}

fun String.convertToPdf(executable: String = "", configuration: Config.() -> Unit = {}): InputStream? {
