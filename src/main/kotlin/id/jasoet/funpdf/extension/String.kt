...
import java.net.URL
fun String.convertToPdf(output: OutputStream, configuration: Config.() -> Unit = {}) {
    HtmlToPdf(configuration = configuration).convert(input = this, output = output)
}

fun String.convertToPdf(output: File, configuration: Config.() -> Unit = {}) {
    HtmlToPdf(configuration = configuration).convert(input = this, output = output)
}

fun String.convertToPdf(configuration: Config.() -> Unit = {}): InputStream? {
